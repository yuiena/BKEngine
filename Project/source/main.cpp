...
void VulkanBase::setImageMemoryBarrier(VkCommandBuffer              commandBuffer,
...
{
	//----------------------------------------------------------------------------------------------------------
	auto vertShaderCode = readFile("F:\\yuiena\\BKEngine\\Project\\res\\shader\\vert.spv");
	auto fragShaderCode = readFile("F:\\yuiena\\BKEngine\\Project\\res\\shader\\frag.spv");
	auto computeShaderCode	= readFile("F:\\yuiena\\BKEngine\\Project\\res\\shader\\shader.comp.spv");
...
SwapChainSupportDetails VulkanBase::querySwapChainSupport(VkPhysicalDevice physicalDevice)
{
...
bool VulkanBase::isDeviceSuitable(VkPhysicalDevice physicalDevice)
{
...
const QueueFamilyIndices& VulkanBase::findQueueFamilies(VkPhysicalDevice device)
{
